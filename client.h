...
public:
	...
	// cheetos
	std::vector<int> pandora_users;
	std::vector<int> kaaba_crack_vmexit;
	std::vector<int> dopium_users;
	std::vector<int> vader_users;
	std::vector<int> fade_users;
	std::vector<int> cheese_beta;
	std::vector<int> fake_hack;
