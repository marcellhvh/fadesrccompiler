...
public:
	...
	//Checkbox      accuracyboost;
	Dropdown	  accuracyboost_amount;
...
public:
	void init() {
		...
		target_limit.setup(XOR("target limit"), XOR("target_limit"), 1, 10, false, 0, 5, 1);
		...
		multipoint.setup(XOR(""), XOR("multipoint"), { XOR("low"), XOR("medium"), XOR("high") }, false);
		...
		minimal_damage.setup(XOR("minimal damage"), XOR("minimal_damage"), 1.f, 100.f, true, 0, 40.f, 1.f, XOR(L"dmg"));
		...
		//accuracyboost.setup(XOR("accuracy boost"), XOR("accuracyboost"));
		//accuracyboost.AddShowCallback(callbacks::IsConfigMM);
		//RegisterElement(&accuracyboost, 1);

		accuracyboost_amount.setup(XOR(""), XOR("accuracyboost_amount"), { XOR("off"), XOR("low"), XOR("medium"), XOR("high") }, false);
		accuracyboost_amount.AddShowCallback(callbacks::IsHitchanceOn);
		accuracyboost_amount.AddShowCallback(callbacks::IsConfigMM);
		RegisterElement(&accuracyboost_amount, 1);

		hitbox_strict.setup(XOR("strict hitbox accuracy"), XOR("hitbox_strict"));
		RegisterElement(&hitbox_strict, 1);
		...
		baim1.setup(XOR("prefer body aim"), XOR("baim1"), { XOR("always"), XOR("lethal"), XOR("lethal x2"), XOR("fake"), XOR("in air"), XOR("breaking lc"), XOR("low chance") });
...
public:
	void init() {
		...
		yaw_stand.setup(XOR("yaw"), XOR("yaw_stnd"), { XOR("off"), XOR("direction"), XOR("swap"), XOR("rotate"), XOR("random") });
		...
		yaw_walk.setup(XOR("yaw"), XOR("yaw_walk"), { XOR("off"), XOR("direction"), XOR("swap"), XOR("rotate"), XOR("random") });
		...
		yaw_air.setup(XOR("yaw"), XOR("yaw_air"), { XOR("off"), XOR("direction"), XOR("swap"), XOR("rotate"), XOR("random") });
		...
		forward.SetToggleCallback(callbacks::ToggleFront);
...
public:
	...
	Checkbox      chams_viewmodel;
	Colorpicker   chams_viewmodel_col;
...
public:
	void init() {
		...
		box_enemy.setup(XOR("box enemy color"), XOR("box_enemy"), Color(255, 255, 255, 80));
		...
		name_color.setup(XOR("name color"), XOR("name_color"), Color(255, 255, 255, 200));
		RegisterElement(&name_color);

		health.setup(XOR("health"), XOR("health"), { XOR("enemy"), XOR("friendly") });
		RegisterElement(&health);

		flags_enemy.setup(XOR("flags enemy"), XOR("flags_enemy"), { XOR("money"), XOR("armor"), XOR("scoped"), XOR("flashed"), XOR("reloading"), XOR("bomb"), XOR("fake"), XOR("resolved"), XOR("doubletap"), XOR("ping"), XOR("lagcomp"), XOR("network")});
		...
		chams_enemy_invis.setup(XOR("color invisible"), XOR("chams_enemy_invis"), { 60, 180, 225, 178 });
		...
		RegisterElement(&chams_local_scope, 1); //chams_viewmodel

		chams_viewmodel.setup(XOR("attachment chams local"), XOR("chams_viewmodel"));
		RegisterElement(&chams_viewmodel, 1); //chams_viewmodel

		chams_viewmodel_col.setup(XOR("color"), XOR("chams_viewmodel_col"), { 255, 255, 200 });
		RegisterElement(&chams_viewmodel_col, 1);
	}
};
...
public:
	...
	Checkbox      tracers;
	MultiDropdown impact_beams;
	Dropdown      impact_beams_type;
	Colorpicker   impact_beams_color;
	Colorpicker   impact_beams_enemy_color;
...
public:
	void init() {
		...
		timer_color.setup(XOR("time bar color "), XOR("timer_color"), colors::white);
		RegisterElement(&timer_color);
		...
		world.setup(XOR("world"), XOR("world"), { XOR("off"), XOR("night"), XOR("fullbright"), XOR("sunset") });
		...
		//sunset.setup(XOR("sunset"), XOR("sunset"));
		//RegisterElement(&sunset);
		...
		impact_beams.setup(XOR("beam bullet tracer"), XOR("impact_beams"), { XOR("local"), XOR("enemy") });
		RegisterElement(&impact_beams, 1);

		impact_beams_type.setup(XOR("beam bullet tracer"), XOR("impact_beams_type"), { XOR("moneybot"), XOR("animated"), XOR("kaaba"), XOR("line") });
		RegisterElement(&impact_beams_type, 1);

		impact_beams_color.setup(XOR("impact beams local color"), XOR("impact_beams_color"), colors::purple);
		RegisterElement(&impact_beams_color, 1);

		impact_beams_enemy_color.setup(XOR("impact beams enemy color"), XOR("impact_beams_enemy_color"), colors::purple);
		RegisterElement(&impact_beams_enemy_color, 1);
...
public:
	...
	Colorpicker grenade_tracer_warning_color;
	Button   ForceUpdate;
...
public:
	void init() {
		...
		client_alpha.setup("client alpha", XOR("client_alpha"), 0.f, 100.f, true, 0, 60.f, 1.f, XOR(L"%"));
		RegisterElement(&client_alpha);

		server_impact.setup(XOR("server color"), XOR("server_impact"), Color(0, 0, 255));
		RegisterElement(&server_impact);

		impact_alpha.setup("server alpha", XOR("server_alpha"), 0.f, 100.f, true, 0, 60.f, 1.f, XOR(L"%"));
		...
		hitmarker3dd.setup(XOR("hitmarker 3d"), XOR("hitmarker3dd"));
		RegisterElement(&hitmarker3dd, 1);
		...
		chams_enemy_mat.setup(XOR("enemy material"), XOR("chams_enemy_mat"), { XOR("texture"), XOR("flat"), XOR("metallic"), XOR("glow"), XOR("wireframe"), XOR("metallic2") });
		RegisterElement(&chams_enemy_mat, 1);

		chams_history_mat.setup(XOR("history material"), XOR("chams_history_mat"), { XOR("texture"), XOR("flat"), XOR("metallic"), XOR("glow"), XOR("wireframe"), XOR("metallic2") });
		RegisterElement(&chams_history_mat, 1);

		chams_local_mat.setup(XOR("local material"), XOR("chams_local_mat"), { XOR("texture"), XOR("flat"), XOR("metallic"), XOR("glow"), XOR("wireframe"), XOR("metallic2") });
		RegisterElement(&chams_local_mat, 1);

		HiddenCvar.setup(XOR("unlock hidden cvars"), XOR("HiddenCvar"));
		...
		grenade_tracer_warning_color.setup(XOR("tracer color"), XOR("tracer color"), colors::red);
		RegisterElement(&grenade_tracer_warning_color, 1);

		ForceUpdate.setup(XOR("force update"));
		ForceUpdate.SetCallback(callbacks::ForceFullUpdate);
		RegisterElement(&ForceUpdate, 1);

		whitelist.setup(XOR("whitelist fade users"), XOR("whitelist"));
		RegisterElement(&whitelist, 1);

		debug_voice.setup(XOR("return voice information"), XOR("debug_voice"));
		RegisterElement(&debug_voice, 1);

		send_data.setup( XOR( "send data to the server" ), XOR( "send_data" ) );
		RegisterElement( &send_data, 1 );
